            ...
            return MaterialApp(
              ...
              theme: ThemeData(
                ...
                chipTheme: ChipThemeData(
                  ...
                  labelStyle: TextStyle(color: lightScheme.onSurfaceVariant, fontSize: 12, fontWeight: FontWeight.w500),
                ),
              ),
              darkTheme: ThemeData(
                useMaterial3: true,
                ...
                chipTheme: ChipThemeData(
                  ...
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                  labelStyle: TextStyle(color: darkScheme.onSurfaceVariant, fontSize: 12, fontWeight: FontWeight.w500),
                ),
              ),
